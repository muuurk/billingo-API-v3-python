...
from swagger_client.models.create_document_export import CreateDocumentExport  # noqa: E501
...
class TestCreateDocumentExport(unittest.TestCase):
    ...
    def testCreateDocumentExport(self):
        ...
        # model = swagger_client.models.create_document_export.CreateDocumentExport()  # noqa: E501
        pass
