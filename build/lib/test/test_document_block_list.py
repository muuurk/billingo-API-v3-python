...
from swagger_client.models.document_block_list import DocumentBlockList  # noqa: E501
...
class TestDocumentBlockList(unittest.TestCase):
    ...
    def testDocumentBlockList(self):
        ...
        # model = swagger_client.models.document_block_list.DocumentBlockList()  # noqa: E501
        pass
