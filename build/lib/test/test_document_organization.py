...
from swagger_client.models.document_organization import DocumentOrganization  # noqa: E501
...
class TestDocumentOrganization(unittest.TestCase):
    ...
    def testDocumentOrganization(self):
        ...
        # model = swagger_client.models.document_organization.DocumentOrganization()  # noqa: E501
        pass
