...
from swagger_client.models.receipt_product_data import ReceiptProductData  # noqa: E501
...
class TestReceiptProductData(unittest.TestCase):
    ...
    def testReceiptProductData(self):
        ...
        # model = swagger_client.models.receipt_product_data.ReceiptProductData()  # noqa: E501
        pass
