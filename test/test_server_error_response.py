...
from swagger_client.models.server_error_response import ServerErrorResponse  # noqa: E501
...
class TestServerErrorResponse(unittest.TestCase):
    ...
    def testServerErrorResponse(self):
        ...
        # model = swagger_client.models.server_error_response.ServerErrorResponse()  # noqa: E501
        pass
